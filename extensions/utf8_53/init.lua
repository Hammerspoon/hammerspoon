...
---
--- The following text is from the preliminary [reference documentation](http://www.lua.org/docs.html) for the Lua 5.3.1 programming language.
---
...
---  * To see a list of the currently defined characters and labels, enter the following code in the Hammerspoon console:
---    * for i,v in pairs(hs.utf8_53.registeredKeys) do print(string.format("(U+%0X) %-15s  %s", hs.utf8_53.codepoint(v), i, v)) end
