-- --- === hs.canvas.drawing ===
-- ---
-- --- An experimental wrapper, to replace `hs.drawing` with `hs.canvas`.
-- ---
-- --- ### Overview
-- ---
...
-- --- ### Usage
-- ---
-- --- This submodule is not loaded as part of the `hs.canvas` module and has to be explicitly enabled.  To enable this wrapper, type the following into your Hammerspoon Console: `hs.settings.set("useCanvasWrappedDrawing", true)` and reload or restart Hammerspoon.
-- ---
