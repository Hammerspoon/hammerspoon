...
function module.getRelativePosition()
    local theScreen = module.getCurrentScreen()
    if theScreen == nil then
        return nil
    end

    local frame = theScreen:fullFrame()
...
--- Returns:
---  * None
function module.setRelativePosition(point, theScreen)
    if theScreen == nil then
        theScreen = module.getCurrentScreen()
        if theScreen == nil then
