api.doc.window.allwindows = {"api.window.allwindows() -> win[]", "Returns all windows"}
function api.window.allwindows()
  return api.fn.mapcat(api.app.runningapps(), api.app.allwindows)
end

api.doc.window.isvisible = {"api.window:isvisible() -> bool", "True if the app is not hidden, not minimized, and is a standard window"}
...
api.doc.window.frame = {"api.window:frame() -> rect", "Get the frame of the window in absolute coordinates."}
...
api.doc.window.setframe = {"api.window:setframe(rect)", "Set the frame of the window in absolute coordinates."}
...
api.doc.window.otherwindows_samescreen = {"api.window:otherwindows_samescreen() -> win[]", "Get other windows on the same screen as self."}
...
api.doc.window.otherwindows_allscreens = {"api.window:otherwindows_allscreens() -> win[]", "Get every window except this one."}
...
api.doc.window.focus = {"api.window:focus() -> bool", "Try to make this window focused."}
function api.window:focus()
  return self:becomemain() and self:app():activate()
end

api.doc.window.visiblewindows = {"api.window.visiblewindows() -> win[]", "Get all windows on all screens that match api.window.isvisible."}
function api.window.visiblewindows()
  return api.fn.filter(api.window:allwindows(), api.window.isvisible)
end

api.doc.window.maximize = {"api.window:maximize()", "Make this window fill the whole screen its on, without covering the dock or menu."}
function api.window:maximize()
  local screenrect = self:screen():frame_without_dock_or_menu()
  self:setframe(screenrect)
end

api.doc.window.screen = {"api.window:screen()", "Get the screen this window is mostly on."}
...
api.doc.window.windows_to_east = {"api.window:windows_to_east()", "Get all windows east of this one, ordered by closeness."}
api.doc.window.windows_to_west = {"api.window:windows_to_west()", "Get all windows west of this one, ordered by closeness."}
api.doc.window.windows_to_north = {"api.window:windows_to_north()", "Get all windows north of this one, ordered by closeness."}
api.doc.window.windows_to_south = {"api.window:windows_to_south()", "Get all windows south of this one, ordered by closeness."}

api.doc.window.focuswindow_east = {"api.window:focuswindow_east()", "Focus the first focus-able window to the east of this one."}
api.doc.window.focuswindow_west = {"api.window:focuswindow_west()", "Focus the first focus-able window to the west of this one."}
api.doc.window.focuswindow_north = {"api.window:focuswindow_north()", "Focus the first focus-able window to the north of this one."}
api.doc.window.focuswindow_south = {"api.window:focuswindow_south()", "Focus the first focus-able window to the south of this one."}
