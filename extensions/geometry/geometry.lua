...
local geometry = require "hammerspoon.geometry.internal"

--- hammerspoon.geometry.rotateccw(point, aroundpoint, ntimes = 1) -> point
--- Function
...
--- hammerspoon.geometry.hypot(point) -> number
--- Function
...
--- hammerspoon.geometry.rect(x, y, w, h) -> rect
--- Constructor
...
--- hammerspoon.geometry.point(x, y) -> point
--- Constructor
...
--- hammerspoon.geometry.size(w, h) -> size
--- Constructor
