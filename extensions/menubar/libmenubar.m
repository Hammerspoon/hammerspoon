...
static int menubarSetTitle(lua_State *L) {
    ...
    if (!titleText && !titleAText) ((__bridge NSStatusItem*)menuBarItem->menuBarItemObject).button.title = @"";
    if (titleText) ((__bridge NSStatusItem*)menuBarItem->menuBarItemObject).button.title = titleText;
    if (titleAText) ((__bridge NSStatusItem*)menuBarItem->menuBarItemObject).button.attributedTitle = titleAText;
