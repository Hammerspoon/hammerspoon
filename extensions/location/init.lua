...
---    * `description`        - the location data in a formatted text string for display purposes. As this field is generated based upon the values of the other fields, it is ignored if provided in a table being used as an argument.
