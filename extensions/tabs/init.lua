--- === hs.tabs ===
---
--- Tab the windows of any application. Draws tabs in the title bar.
local tabs = {}
...
--- Function
--- Gets a list of the tabs of a window. Use to write switching functions.
---
--- Parameters:
---  * An application object
---
--- Returns:
---  * Array of the tabbed windows of an app in the same order as they would be tabbed
...
--- Function
--- Starts tabbing the windows of an app. All windows will be herded into one stack and kept together.
---
--- Parameters:
---  * An application object
---
...
--- Function
--- Focuses a tab of an app. Numbers greater than the number of tabs focus the last tab.
---
--- Parameters:
---  * A tabbed application object
---  * A number >=1 of the tab
---
--- Returns:
---  * None
