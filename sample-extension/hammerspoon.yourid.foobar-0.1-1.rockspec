...
package = "hammerspoon.yourid.foobar"
...
local url = "github.com/yourname/hammerspoon.yourid.foobar"
...
dependencies = {
  ...
  -- i.e. "hammerspoon.application", "hammerspoon.hotkey", whatever.
  --
  -- For example, if your module depends on `hammerspoon.fnutils`,
...
build = {
  ...
  modules = {
    ...
    ["hammerspoon.yourid.foobar"] = "foobar.lua",

    -- If you have an internal C or Objective-C submodule, include it here:
    ["hammerspoon.yourid.foobar.internal"] = "foobar.m",
