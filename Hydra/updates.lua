...
doc.api.updates.notyet = {"api.updates.notyet = function()", "Called when no update is avaiable, determined by api.updates.check(); default implementation does nothing."}
