...
api.doc.hotkey.bind = {"api.hotkey.bind(...) -> hotkey", "Shortcut for: return api.hotkey.new(...):enable()"}
function api.hotkey.bind(...)
  return api.hotkey.new(...):enable()
end

api.doc.hotkey.disableall = {"api.hotkey.disableall()", "Disables all hotkeys; automatically called when user config reloads."}
